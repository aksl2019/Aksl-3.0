...
//            {
//                throw new FormatException($"Format Invalid Url :{url}");
//            }
//            int schemeDelimiterEnd = schemeDelimiterStart + "://".Length;

//            var isUnixPipe = url.IndexOf(UnixPipeHostPrefix, schemeDelimiterEnd, StringComparison.Ordinal) == schemeDelimiterEnd;
...
//            else
//            {
//                pathDelimiterStart = url.IndexOf(":", schemeDelimiterEnd + UnixPipeHostPrefix.Length, StringComparison.Ordinal);
