...
namespace Aksl.Sockets.Client.Configuration
{
    public class AddressParser
    {
        ...
        {
            return Parse(address, out bool https);
        }

        internal static EndPointInformation Parse(string address, out bool https)
        {
            ...
            endPointInformation.Scheme = parsedAddress.Scheme;
