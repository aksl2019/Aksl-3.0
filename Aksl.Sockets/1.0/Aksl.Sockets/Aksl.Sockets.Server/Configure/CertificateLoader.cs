        ...
        public static X509Certificate2 LoadFromStoreCert(string subject, string storeName, StoreLocation storeLocation, bool allowInvalid)
        {
            using (var store = new X509Store(storeName, storeLocation))
            {
                ...
                try
                {
                    ...
                    {
                        throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, CoreStrings.CertNotFoundInStore, subject, storeLocation, storeName, allowInvalid));
                    }
