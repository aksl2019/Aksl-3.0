...
namespace Aksl.Sockets.Server.Configure
{
    internal class AddressBinder
    {
                                           ...
                                           Func<ListenOptions, Task> createBinding)
        {
            ...
            var strategy = CreateStrategy(listenOptions.ToArray(),
        ...
        #region Create Strategy Methods
        ...
        internal static async Task BindEndpointAsync(ListenOptions endpoint, AddressBindContext context)
        {
            ...
            {
                throw new IOException($"Format Endpoint AlreadyInUse :{ endpoint}", ex);
            }
        ...
        internal static ListenOptions ParseAddress(string address, out bool https)
        {
            ...
            {
                throw new InvalidOperationException($"Format Configure PathBase From MethodCall({nameof(AddressBinder)}.UsePathBase()");
            }
            ...
            options.Scheme = parsedAddress.Scheme;
