...
namespace Contoso.ConsoleApp
{
    public partial class WebApiSender
    {
        ...
        public async Task PipeBulkInsertBlockTasksAsync(int taskCount = 10, int orderCount = 5000)
        {
            if (!_isInitialize)
            {
            ...
            var logger = _loggerFactory.CreateLogger($"PipeBulkBlockInser-OrderCount:{totalOrderCount}");
