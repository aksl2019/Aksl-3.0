...
namespace Aksl.Pipeline
{
    public sealed class PipeTextWriter : TextWriter
    {
        ...
        #region Constructors
        public PipeTextWriter(PipeWriter writer, Encoding encoding, bool writeBOM, bool closeWriter, bool autoFlush)
        {
...
//#endif
        ...
        /// </summary>
        public static PipeTextWriter Create(PipeWriter writer, Encoding encoding, bool writeBOM = false, bool closeWriter = true, bool autoFlush = true)
