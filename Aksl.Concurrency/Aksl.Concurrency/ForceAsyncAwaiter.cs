...
namespace Aksl.Concurrency
{
    public static class ForceAsyncTaskExtensions
    {
        ...
        /// </summary>
        public static ForceAsyncAwaiter ForceAsync(this Task task) => new ForceAsyncAwaiter(task);

        public static ForceAsyncAwaiter<T> ForceAsync<T>(this Task<T> task) => new ForceAsyncAwaiter<T>(task);
    }
